...
import com.ucsc.groupone.frameworkide.StartFrame;
...
public class CreateProject extends javax.swing.JDialog {
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if(!projectFolder.exists()){    
            ...
            if(folderCreated){
                SystemVariables.setProjectRootFolder(projectFolder.getAbsolutePath());
    ...
    private void initFields() {
        projectLocationField.setText(System.getProperty("user.home").concat("/FrameworkIDE"));
